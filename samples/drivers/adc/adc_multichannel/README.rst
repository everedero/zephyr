.. zephyr:code-sample:: adc_multichannel
   :name: Analog-to-Digital Converter (ADC) with sequence containing multiple channels
...
To build for another board, change "nucleo_f756zg" above to that board's name
